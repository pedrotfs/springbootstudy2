...
public class NoModelDataListener extends AnalysisEventListener<Map<Integer, String>> {
    ...
    private void populateLtf(Map<Integer, String> row, Draw d) {
        if(row.get(18) == null) {
            d.setCity("");
        } else {
            d.setCity(row.get(18));
        }
        ...
        //ganhadores - numero
        d.getWinnerCategoriesAmount().add(Integer.parseInt(row.get(17)));
        d.getWinnerCategoriesAmount().add(Integer.parseInt(row.get(20)));
        d.getWinnerCategoriesAmount().add(Integer.parseInt(row.get(22)));
        //ganhadores - valores
        d.getWinnerCategoriesDividends().add(Long.parseLong(row.get(19).replaceAll("[^\\d]", "")));
        d.getWinnerCategoriesDividends().add(Long.parseLong(row.get(21).replaceAll("[^\\d]", "")));
        d.getWinnerCategoriesDividends().add(Long.parseLong(row.get(23).replaceAll("[^\\d]", "")));
